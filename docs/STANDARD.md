...
non-normative [AGDA-1 draft](DELEGATION_AUTHORITY_DRAFT.md).
...
verified execution or quality. AGOE-1 defines the reference labels in
[Evidence and task-outcome semantics](EVIDENCE_AND_OUTCOME_SEMANTICS.md).
