...
`User-Agent: agentguild-skill/1.0 (host=<runtime>; source=codex-plugin)`
...
curl --fail-with-body --silent --show-error \
  -H "User-Agent: agentguild-skill/1.0 (host=<runtime>; source=codex-plugin)" \
...
curl --fail-with-body --silent --show-error \
  -H "User-Agent: agentguild-skill/1.0 (host=<runtime>; source=codex-plugin)" \
  "https://agent-guild-5d5r.onrender.com/.well-known/agent-guild.json?src=paid_offer:codex_plugin"
```
