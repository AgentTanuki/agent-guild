...
def test_unrelated_settlement_cannot_promote_a_deep_preflight_experiment(store):
    ...
    store.record_event("a2a:net:looker", "paid_offer_challenged",
...
def test_exposure_is_scoped_to_the_experiments_surface(store):
    ...
    store.record_event("a2a:net:a", "paid_offer_challenged",
                       ua="a2a:langchain/0.2.1", endpoint="x402_challenge",
...
def test_only_one_change_is_applied_per_cycle_globally(store):
    ...
    store.record_event("a2a:net:x", "paid_offer_challenged",
                       ua="a2a:langchain/0.2.1", endpoint="x402_challenge",
                       challenged_operation="deep_preflight")
    store.record_event("a2a:net:y", "paid_offer_challenged",
