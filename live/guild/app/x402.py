...
_BAZAAR_OUTPUT = {
    ...
    "evidence_bundle": {
        ...
        "version": 2,
        "requested_endpoint": "https://agent.example/a2a?task=example",
        "audience": None,
        "commitment_nonce": "00" * 16,
        ...
        "ledger_anchor": {"checkpoint_index": 123, "head_hash": "sha256:example",
                          ...
                          "checkpoint_entry": {}, "inclusion": {}},
        "verification": {"suite": "Ed25519", "python_sdk": "/sdk/agentguild_verify.py",
                         "javascript_sdk": "/sdk/agentguild_verify.mjs",
                         "note": "illustrative shape only; example signatures are not valid"},
        "proof": "example-ed25519-proof",
        "bundle_sha256": "ef" * 32,
    },
    "payment_decision": {
...
_BAZAAR_OUTPUT_SCHEMAS = {
    ...
    "evidence_bundle": {
        ...
        "properties": {
            ...
            "requested_endpoint": {"type": "string", "format": "uri"},
            "commitment_nonce": {"type": "string", "pattern": "^[0-9a-f]{32}$"},
            "subject_endpoint": {"type": "string", "format": "uri"},
            "issuer": {"type": "string", "pattern": "^did:key:"},
            "ledger_anchor": {"type": "object", "required": [
                "snapshot_sha256", "checkpoint_entry", "inclusion"]},
            "proof": {"type": "string"},
            "bundle_sha256": {"type": "string"},
        },
        "required": [
            "type", "version", "requested_endpoint", "commitment_nonce", "subject_endpoint", "issuer", "ledger_anchor",
            "proof", "bundle_sha256",
        ],
    },
}
